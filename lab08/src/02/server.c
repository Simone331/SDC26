    ...
    while (1) {
         ...
         */
            ...
            while (bytes_sent < recv_bytes) {
                ret = sendto(socket_desc, buf + bytes_sent, recv_bytes - bytes_sent, 0, (struct sockaddr*) &client_addr, sockaddr_len);
...
int main(int argc, char* argv[]) {
     ...
     */
        ...
        if (bind(socket_desc, (struct sockaddr*) &server_addr, sockaddr_len) == -1) {
